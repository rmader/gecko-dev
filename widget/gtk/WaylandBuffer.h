...
class WaylandShmBuffer final : public WaylandBuffer {
 public:
  static RefPtr<WaylandShmBuffer> Create(const LayoutDeviceIntSize& aSize);
...
class WaylandDMABUFBuffer final : public WaylandBuffer {
 public:
