...
class NativeLayerRootWayland : public NativeLayerRoot {
 ...
 protected:
  ...
  ~NativeLayerRootWayland() override;

  void ShowLayer(RefPtr<NativeLayerWayland> aLayer);
  void HideLayer(RefPtr<NativeLayerWayland> aLayer);
